...
set_property IODELAY_GROUP dvi2rgb_iodelay_grp [get_cells i_hdmi_io/i_hdmi_input/IDELAYCTRL_inst]
set_property IODELAY_GROUP dvi2rgb_iodelay_grp [get_cells i_hdmi_io/i_hdmi_input/ch*/i_deser/IDELAYE2_inst]
#set_property IODELAY_GROUP dvi2rgb_iodelay_grp [get_cells i_hdmi_io/in_rx*_buf]


set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets i_hdmi_io/i_hdmi_input/clk_pixel_x5_raw]
set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets i_hdmi_io/i_hdmi_input/clk_pixel_x1_raw]
...
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports hdmi_tx_rscl]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports hdmi_tx_rsda]
...
#Pmod Header JE
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { debug_pmod[0] }]; #IO_L4P_T0_34 Sch=je[1]
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { debug_pmod[1] }]; #IO_L18N_T2_34 Sch=je[2]
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { debug_pmod[2] }]; #IO_25_35 Sch=je[3]
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { debug_pmod[3] }]; #IO_L19P_T3_35 Sch=je[4]
#set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { debug_pmod[4] }]; #IO_L3N_T0_DQS_34 Sch=je[7]
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { debug_pmod[5] }]; #IO_L9N_T1_DQS_34 Sch=je[8]
#set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { debug_pmod[6] }]; #IO_L20P_T3_34 Sch=je[9]
#set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { debug_pmod[7] }]; #IO_L7N_T1_34 Sch=je[10]
